    ...
    <div className="slider-frame relative">
      ...
      <div className="slider-btns absolute z-[1] text-2xl flex gap-10 bottom-20 left-0 right-0 w-fit m-auto">
        <button
          ...
          className="prev-slide-btn h-14 w-20  flex justify-center items-center bg-violet-900 text-violet-200 border-2 border-violet-200 hover:bg-gray-900 hover:text-gray-200 hover:border-gray-200 duration-300"
        >
          <span>
            <BsArrowLeft />
          </span>
        ...
        <button
          onClick={nextSlide}
          className="next-slide-btn h-14 w-20  flex justify-center items-center bg-violet-900 text-violet-200 border-2 border-violet-200 hover:bg-gray-900 hover:text-gray-200 hover:border-gray-200 duration-300"
        >
          <span>
            <BsArrowRight />
          </span>
